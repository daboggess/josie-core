...
class JosieTests(unittest.TestCase):
    ...
    def test_service_gate_requires_immutable_images_and_local_preflight(self) -> None:
        ...
        self.assertTrue("d:\\josie-storage" in lowered or "i:\\josie-storage" in lowered)
    ...
    def test_native_model_rollout_is_allowlisted_and_stored_on_external_disk(self) -> None:
        ...
        self.assertTrue("d:\\josie-storage\\apps\\ollama\\0.32.5" in installer or "i:\\josie-storage\\apps\\ollama\\0.32.5" in installer)
        self.assertTrue("d:\\josie-storage\\models\\ollama" in server or "i:\\josie-storage\\models\\ollama" in server)
        ...
        self.assertTrue('enable_openai_api: "false"' in compose or 'enable_openai_api: "true"' in compose)
